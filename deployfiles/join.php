                        ...
                        <div class="row gx-5 justify-content-center">
                            <div class="col-lg-8 col-xl-6">
                                ...
                                <form id="contactForm" data-sb-form-api-token="API_TOKEN">
                                    ...
                                    <div class="form-floating mb-3">
                                        <input class="form-control" id="passwd" type="password" class="pass" placeholder="Enter your passwd..." data-sb-validations="required" />
                                        <label for="passwd">PW 입력</label>
                                        <div class="invalid-feedback" data-sb-feedback="passwd:required">PW를 입력하지 않았습니다.</div>
                                    </div>        
                                    <div class="form-floating mb-3">
                                        <input class="form-control" id="pass_confirm" type="password" class="pass" placeholder="Enter your passwd..." data-sb-validations="required" />
                                        <label for="passwd">PW 확인</label>
                                        <div class="invalid-feedback" data-sb-feedback="passwd:required">PW를 입력하지 않았습니다.</div>
                                    </div>                  
                                    <div class="form-floating mb-3">
                                        <input class="form-control" id="name" type="text" class="nick" placeholder="Enter your nick..." data-sb-validations="required" />
                                        <label for="name">이름 입력</label>
                                        <div class="invalid-feedback" data-sb-feedback="name:required">이름를 입력하지 않았습니다.</div>
                                    </div>              
                                    <div class="form-floating mb-3">
                                        <input class="form-control" id="nick" type="text" class="nick" placeholder="Enter your nick..." data-sb-validations="required" />
                                    ...
                                    <div class="d-grid">
                                       ...
                                       <a class="btn btn-primary" onClick="javascript:location.href='./member_insert.php';">회원가입</a>
